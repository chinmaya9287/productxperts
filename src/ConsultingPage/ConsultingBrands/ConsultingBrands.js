...
import './ConsultingBrands.css'

const ConsultingBrands = () => {
  return (
    <>
<div className='logoconsult'>

<div className='logotitleconsult container'>
<h3>OUR PRODUCT MANAGEMENT CONSULTING EXPERIENCE</h3> <br />
...
export default ConsultingBrands